local GroundedCheck2D = Object:extend("GroundedCheck2D")

function GroundedCheck2D:check_grounded(object)
...
function GroundedCheck2D:__mix_init()
...
function GroundedCheck2D:on_landed()
    -- override this
end

function GroundedCheck2D:on_takeoff()
	-- override this
end

return GroundedCheck2D

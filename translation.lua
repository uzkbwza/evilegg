local translations = {
    en = {
        ...
        artefact_ring_of_loyalty_name  = "RING OF DISPERSAL",
        ...
        artefact_ring_of_loyalty_desc  = "Saved Greenoids repel nearby enemies.",
        ...
        options_debug_enabled                        = "Enable Debug Mode",
        options_use_absolute_aim                     = "Relative Mouse Aim",
        ...
        options_show_hud                             = "Show HUD",
        options_gamepad_plus_mouse                   = "Gamepad + Mouse",
        options_retry_cooldown                       = "Retry Cooldown",
        ...
        options_set_window_size                      = "Windowed Pixel Scale",
        ...
        cutscene_final_score                = "FINAL SCORE",
    },
}

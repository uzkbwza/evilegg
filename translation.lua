local translations = {
    en = {
		...
		codex_desc_gnome               = "He knows it is cruel to laugh and laughs anyway.",
        ...
        codex_name_evilgreenoidboss    = "Yolk",
        codex_desc_evilgreenoidboss    = "What good is victory if you have to stop fighting?",

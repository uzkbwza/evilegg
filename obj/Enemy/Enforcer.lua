local Enforcer = require("obj.Enemy.BaseEnemy"):extend("Enforcer")
local EnforcerBullet = require("obj.Enemy.EnforcerBullet")
...
--     --     local clamped_x, clamped_y = vec2_clamp(self.pos.x, self.pos.y, 0, MAX_DIST)

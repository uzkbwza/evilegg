...
function World:use_basic_culling(draw_cell_size)
    self.draw_grid = self:add_spatial_grid("draw_grid", draw_cell_size or 64)

	self.get_visible_objects = function(self)
		self.draw_object_table = self.draw_object_table or {}
		local x, y, w, h = -self.camera_offset.x, -self.camera_offset.y, self.viewport_size.x, self.viewport_size.y
	...
	self.show_object = function(self, obj)
	...
	self.hide_object = function(self, obj)
